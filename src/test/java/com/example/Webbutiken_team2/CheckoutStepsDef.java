...
public class CheckoutStepsDef {
    ...
    @Before
    public void maximizeWindow(){//Yevheniia Kornilova
    ...
    @Then("the welcome message is present")//Yevheniia Kornilova
    ...
    @Then("no error is present")//Yevheniia Kornilova
    ...
    @When("fill fields with values {string}, {string}, {string}, {string}, {string}, {string}, {string}")//Yevheniia Kornilova
    ...
    @When("choose [debit card] radio button")//Yevheniia Kornilova
    ...
    @When("continue filling the fields with values {string}, {string}, {string}, {string}")//Yevheniia Kornilova
    ...
    @When("click on the [Continue to checkout] button")//Yevheniia Kornilova
    ...
    @Then("error messages are present")//Yevheniia Kornilova
    public void error_messages_are_present() {
        List<WebElement> errorMessages = driver.findElements(By.xpath("//*[@class = 'invalid-feedback']"));
        boolean isErrorPresent = errorMessages.getFirst().isDisplayed();
        assertTrue(isErrorPresent);
    }
    @When("choose PayPal by radiobutton")//Yevheniia Kornilova
    ...
    @Then("credit card fields disappear")//Yevheniia Kornilova
