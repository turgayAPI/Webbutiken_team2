...
public class AllProductsStepsDef { //Yevheniia Kornilova
    ...
    @Given("the user on the products page")//Yevheniia Kornilova
    ...
    @When("click on the All products link")//Yevheniia Kornilova
    ...
    @Then("all products are present on the page")//Yevheniia Kornilova
    ...
    @Then("the amount of products equal {int}")//Yevheniia Kornilova
