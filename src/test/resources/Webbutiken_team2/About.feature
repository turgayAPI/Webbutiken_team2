Feature: About Page Content and Navigation
  US:   As a user
  ...
  Scenario: Navigating to the About page from the Homepage
  ...
  Scenario: Presence of essential navigation links and footer text
    Given the user is on the About page
  ...
  Scenario: All navigation links should lead to the correct pages
    Given the user is on the About page
