Feature: Home page //Yevheniia Kornilova
  ...
  Scenario: check home pages title //Yevheniia Kornilova
    Then home pages title is "The Shop"

  Scenario: Check if the "Home" link is on the toolbar and leads on the home page//Yevheniia Kornilova
    Then Home link is present
    When click on the Home link
    And the user goes to the home page

  Scenario: Check if the "Shop" link is on the toolbar and leads on the home page //Yevheniia Kornilova
    Then Shop link is present
    When click on the Shop link
    And the user goes to the shop page

  Scenario: Check if the "Checkout" button is on the toolbar and leads on the checkout page //Yevheniia Kornilova
    Then Checkout button is present
    When click on the Checkout button
    And the user goes to the checkout page

  Scenario: check if title on home page is present //Yevheniia Kornilova
    Then title on the home page is present

  Scenario: check if description of Webshop is present on the home page //Yevheniia Kornilova
    Then description of Webshop is present on the home page

  Scenario: check if image of product is present on the home page //Yevheniia Kornilova
  ...
  Scenario: check if copyright is present on the home page //Yevheniia Kornilova
    Then the copyright is present on the page

  Scenario: check if navigation links are present on the button of home page//Yevheniia Kornilova
